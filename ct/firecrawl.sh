#!/usr/bin/env bash
source <(curl -fsSL https://raw.githubusercontent.com/esatbayhan/proxmox-community-scripts/firecrawl-script/misc/build.func)
# TODO: revert to upstream before PR merge:
